...
from model_pointcloud import ResnetPointnet, ResnetBlockFC
...
class LocalPoolPointnet(nn.Module):
    ...
    def __init__(self, c_dim=128, dim=3, hidden_dim=128, scatter_type='max', 
                 ...
                 plane_resolution=64, grid_resolution=None, plane_type='xz', padding=0.1, n_blocks=5):
        super().__init__()
        self.c_dim = c_dim
